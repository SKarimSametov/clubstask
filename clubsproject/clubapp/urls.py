...
from . import views
from .views import sing_up_page, login_page, logout_page
...
urlpatterns = [
    ...
    path('guides/', views.guides, name='guides_page'),
    path('jobs/<int:pk>/', views.job_detail_page, name='job_detail_page'),
    path('guides/<int:pk>/', views.guides_detail_page, name='guides_detail_page'),
